...
class DataProcessor:
    ...
    def connect_mongo(self):
        try:
            return MongoClient(os.getenv("MONGO_HOST"),int(os.getenv("MONGO_PORT")))
    ...
    def insert_data_history(self):
        try:
            with open("server/cache.py", "r") as f:
                data = f.read()
    ...
    def insert_monthly_average(self, new_rate: json):
        try:
            # while True:
